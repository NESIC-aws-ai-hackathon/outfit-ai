...
ユーザーは手持ち服を登録し、当日の予定（Google Calendar取得または手動補足）や「どう見られたいか」を入力する。AIは天気、気温、降水確率、予定内容、移動量、過去の着用履歴を統合し、"今日の人格"を生成する。

たとえば顧客訪問なら「信頼感のある人」、展示会なら「動ける人」、デートなら「やわらかく見える人」として、手持ち服から服装を決定し、選定理由・除外理由も提示する。

### 設計思想

狙いは、服選びを便利にすることではなく、**朝の服選び・TPO判断・自己演出までAIに任せきる"着るだけの怠惰"を実現すること**である。AIは予定・天気・手持ち服をもとに"今日どう見られるべきか"を定義し、それを服装として出力する。ここでいう「今日の人格」とは性格診断ではなく、予定・TPO・見られたい印象から定義される外向きの印象設計である。
